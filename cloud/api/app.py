...
from cloud.utils.pg import pg_context, TreeRecordsHolder
from .handlers import HANDLERS
from .middleware import error_middleware
from .payloads import JsonPayload, AsyncGenJsonListPayload, JsonNodeTreeAsyncGenPayload
...
def create_app(args: Settings) -> Application:
    ...
    PAYLOAD_REGISTRY.register(JsonNodeTreeAsyncGenPayload, TreeRecordsHolder)
    return app
